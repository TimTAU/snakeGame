...
class MainActivity : AppCompatActivity(), SensorEventListener, GestureDetector.OnGestureListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        } else { //Disable Tilt setting if accelerometer is not available
    ...
    override fun onPointerCaptureChanged(hasCapture: Boolean) { //Do nothing
    }
    ...
    override fun onShowPress(e: MotionEvent) { //Do nothing special
    }
    ...
    override fun onLongPress(e: MotionEvent) { //Do nothing special
    }
